...
The results here, while indicative of trends are mostly not statistically significant and thus we do not make \textit{significant} claims about our conclusions. Rather, we use the results to inform interesting insights and to pose further work in this area.
...
\section {Future work}
We have discussed how the separability of voting options and the cognative load of the voting algorithm in question may confound results from a subset selection application where a crowd is asked to find a contextually relevant subset of points. Futher research will involve understanding the impact of this context separability and outlining what scenarios should explicitly consider this factor. Moreover, work on cognative load and voter fatigue (when ranking options, many participants made general placements of items as they were overwhelmed by the specifics of any one pairwise comparison) of the voting algorithm may help to shed light on the performance and stability of the voting schema.
